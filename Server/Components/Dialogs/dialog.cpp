...
public:
	...
	void show(IPlayer& player, int id, DialogStyle style, StringView title, StringView body, StringView button1, StringView button2) override
	{
		...
		char tis620_buffer[512];
		char tis620_buffer2[4096];
		char tis620_buffer3[512];
		char tis620_buffer4[512];
		...
		convert.utf8_to_tis620(fix_title, tis620_buffer, sizeof(tis620_buffer));
		convert.utf8_to_tis620(fix_body, tis620_buffer2, sizeof(tis620_buffer2));
		convert.utf8_to_tis620(fix_button1, tis620_buffer3, sizeof(tis620_buffer3));
		convert.utf8_to_tis620(fix_button2, tis620_buffer4, sizeof(tis620_buffer4));
